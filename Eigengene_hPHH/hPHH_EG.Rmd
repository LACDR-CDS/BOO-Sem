...
$$
wGRR(M_j) = \frac{ \displaystyle \sum_{i = 1}^{n_j} \left( |\log_2 \mathrm{FC}_i| > 1.0 \land p_{\mathrm{adj},i} < 0.05 \right) \cdot \mathrm{median(TOM)}_i \cdot \mathrm{sign(\log_2 \mathrm{FC}_i)}}{ n_j }
$$
