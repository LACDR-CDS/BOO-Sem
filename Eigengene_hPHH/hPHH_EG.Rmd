...
outliers_per_module %>%
  ...
  coord_flip() +
  theme_minimal() +
  labs(title = "Top 30 modules with significant GRR outliers based on binomial GLM in PHH",
       x = "Module number",
...
outliers_per_sample %>%
  ...
  coord_flip() +
  theme_minimal() +
  labs(title = "Top 30 conditions with significant GRR outliers in PHH",
...
outliers_annotated %>%
  ...
  theme_minimal() +
  labs(
    title = "Top 20 modules with significant GRR outliers in PHH",
    x = "Module",
...
To compare this with RPTEC the number of outliers will be compared relative to the total modules and conditions.
