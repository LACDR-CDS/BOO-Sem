...
Lots of weird values with high scores and low GRR
...
ggplot(GRR_glm_fit_df, aes(x = eg_score, y = abs(GRR))) +
  ...
  theme_minimal() +
  labs(
    title = "abs(GRR) vs EG Score with Significant Outliers in RPTEC",
    x = "Eigengene Score (EG)",
    y = "Absolute Gene Response Rate (GRR)"
  )
```
