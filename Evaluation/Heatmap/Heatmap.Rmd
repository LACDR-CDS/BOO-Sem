...
```{r, wrangle, include=TRUE, echo=TRUE}
selected_modules <- bind_rows(
  data.frame(KE = "Mitochondria", module = paste("hPHH",sort(c(2,33,97)), sep = "_")),
  data.frame(KE = "Endoplasmic Reticulum", module = paste("hPHH",sort(c(13,15,295,62)), sep = "_")),
  data.frame(KE = "Lysosome", module = paste("hPHH",c(131,17, 82,95), sep = "_")),
  data.frame(KE = "Immune Response", module = paste("hPHH",sort(c(12,136,22,247,26)), sep = "_")),
  data.frame(KE = "Oxidative Stress", module = paste("hPHH",c(144,337), sep = "_")),
...
draw(object = heatmap1 + heatmap3 + heatmap2 + heatmap6 + heatmap7 + heatmap8 +heatmap9 + heatmap_last + heat_legend, 
     merge_legend = TRUE, 
     annotation_legend_side = "bottom",
     heatmap_legend_side = "bottom",
...
##### ADJUST COLOR HERE #####
seq_vals <- c(-1, -0.75, -0.5, 0, 0.5, 1, 2)
