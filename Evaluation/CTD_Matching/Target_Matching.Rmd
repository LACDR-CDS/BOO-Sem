...
```{r}
accuracy_results$dataset <- factor(accuracy_results$dataset, levels = c("PHH_EG", "PHH_wDRW", "RPTEC_EG", "RPTEC_wDRW"))
```

Plot

*TO DO* Drop the Epidermal growth factor and dont calculate it in accuracy calculation 
