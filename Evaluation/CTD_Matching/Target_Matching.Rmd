...
k_values <- c(20, 40, 60, 80, 100) # for now k is in 10, 20, 30, 40, 50
```
...
# combined results
result_dfs <- list(
  RPTEC_drw = top100_results_RPTEC_drw,
  RPTEC_eg  = top100_results_RPTEC_eg,
  PHH_drw   = top100_results_PHH_drw,
...
print(accuracy_wide)
```
Rearranging for plot

```{r}
accuracy_results$dataset <- factor(accuracy_results$dataset, levels = c("PHH_eg", "PHH_drw", "RPTEC_eg", "RPTEC_drw"))
```
