...
$$
W_{t+1} = (1 - r) A_{Mj} \cdot W_t + r W_0
$$
...
$$
wDRW(M_j) = \frac{ \sum_{i}^{n_j} W_\infty(g_i) \cdot \left| \log_2 \mathrm{FC}(g_i) \right| }{n_j \cdot \sqrt{\sum_{i}^{n_j} \left( W_\infty(g_i) \right)^2 } }
$$
